...
class NewAgent(mlflow.pyfunc.ChatModel):
    ...
    def get_multiple_random_jokes(self, n):
        """
        This function retrieves n random jokes from the Official Joke API.
    ...
    def get_jokes_by_type(self, joke_type, n=1):
        """
        This function retrieves n jokes of a specific type from the Official Joke API.
        ...
        Returns:
        list: A list of n jokes of the specified type.
        """
        url = f"https://official-joke-api.appspot.com/jokes/{joke_type}/{n}"
        response = requests.get(url)
        return response.json()

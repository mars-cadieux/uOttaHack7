...
class NewAgent(mlflow.pyfunc.ChatModel):
    ...
    def predict(self, context, messages: list[ChatMessage], params: ChatParams):
        ...
        if tool_calls:
            for tool_call in tool_calls:
                tool_response = ChatMessage(
                    role="tool",
                    content=globals()[tool_call.function.name](
        ...
        def get_random_jokes(self, n):
            ...
            Parameters:
            n (int): The number of jokes to retrieve.
...
set_model(NewAgent([{'function': {'name': 'get_random_joke', 'description': 'This function returns a random joke.\n    \n    Returns:\n    dict: A dictionary containing the joke data.', 'parameters': {'properties': {}, 'type': 'object'}, 'strict': False}, 'type': 'function'}, {'function': {'name': 'get_joke_types', 'description': 'This function returns a list of joke types.\n    \n    Returns:\n    list: A list of joke types.', 'parameters': {'properties': {}, 'type': 'object'}, 'strict': False}, 'type': 'function'}, {'function': {'name': 'get_random_jokes', 'description': 'This function returns a specified number of random jokes.\n    \n    ', 'parameters': {'properties': {'n': {'type': 'integer', 'description': 'The number of jokes to retrieve.'}}, 'type': 'object'}, 'strict': False}, 'type': 'function'}, {'function': {'name': 'get_jokes_by_type', 'description': 'This function returns a specified number of jokes of a specific type.\n    \n    ', 'parameters': {'properties': {'joke_type': {'type': 'string', 'description': 'The type of joke to retrieve.'}, 'n': {'type': 'integer', 'description': 'The number of jokes to retrieve. Default is 1.'}}, 'type': 'object'}, 'strict': False}, 'type': 'function'}, {'function': {'name': 'get_joke_by_id', 'description': 'This function returns a joke by ID.\n    \n    ', 'parameters': {'properties': {'joke_id': {'type': 'integer', 'description': 'The ID of the joke to retrieve.'}}, 'type': 'object'}, 'strict': False}, 'type': 'function'}], ['get_random_joke', 'get_joke_types', 'get_random_jokes', 'get_jokes_by_type', 'get_joke_by_id']))
...
class NewAgent(mlflow.pyfunc.ChatModel):
    ...
    def get_joke_types(self):
        """
        This function retrieves the list of joke types from the Official Joke API.
...
set_model(NewAgent([{'function': {'name': 'get_random_joke', 'description': 'This function retrieves a random joke from the Official Joke API.\n    \n    Returns:\n    dict: A dictionary containing the random joke data.', 'parameters': {'properties': {}, 'type': 'object'}, 'strict': True}, 'type': 'function'}, {'function': {'name': 'get_joke_types', 'description': 'This function retrieves the list of joke types from the Official Joke API.\n    \n    Returns:\n    list: A list of joke types.', 'parameters': {'properties': {}, 'type': 'object'}, 'strict': True}, 'type': 'function'}, {'function': {'name': 'get_random_jokes', 'description': 'This function retrieves a specified number of random jokes from the Official Joke API.\n    \n    ', 'parameters': {'properties': {'n': {'type': 'integer', 'description': 'The number of random jokes to retrieve.'}}, 'type': 'object'}, 'strict': True}, 'type': 'function'}, {'function': {'name': 'get_jokes_by_type', 'description': 'This function retrieves a specified number of jokes of a specific type from the Official Joke API.\n    \n    ', 'parameters': {'properties': {'joke_type': {'type': 'string', 'description': 'The type of joke to retrieve.'}, 'n': {'type': 'integer', 'description': 'The number of jokes to retrieve (default is 1).'}}, 'type': 'object'}, 'strict': True}, 'type': 'function'}, {'function': {'name': 'get_joke_by_id', 'description': 'This function retrieves a joke by its ID from the Official Joke API.\n    \n    ', 'parameters': {'properties': {'joke_id': {'type': 'integer', 'description': 'The ID of the joke to retrieve.'}}, 'type': 'object'}, 'strict': True}, 'type': 'function'}], ['get_random_joke', 'get_joke_types', 'get_random_jokes', 'get_jokes_by_type', 'get_joke_by_id']))